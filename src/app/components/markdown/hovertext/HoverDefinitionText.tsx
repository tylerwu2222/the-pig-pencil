...
const HoverDefinitionText = ({
  ...
  return (
    ...
    >
      <span
        className={`left-1/2 top-5 mt-1 min-w-[50vw] max-w-[80vw] -translate-x-1/2 rounded-lg border-[1px] border-lime-400 bg-backgroundWhite p-3 shadow-lg sm:left-10 sm:min-w-[20vw] sm:max-w-[30vw] ${isVisible ? "absolute block" : "hidden"}`}
      >
      ...
      <span
        className={`${isVisible ? "rounded-t-md" : "rounded-md"} cursor-text bg-lime-400 p-1`}
      >
        {children}
      </span>
    </span>
