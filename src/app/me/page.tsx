    ...
    return (
        <>
            <div id="me-container-div">
                ...
                <div className='relative h-[100vh] ml-[15vw]'>
                    ...
                    <img
                        ...
                        alt="me-faucet"
                    />
                    <h1 id='title-header' className='absolute top-[65vh] right-[10vw] pl-0 z-10 text-2xl 2xl:text-6xl text-[#676464] font-["Baskerville"] font-bold'> HOW I FOUND DATA VISUALIZATION ♱</h1>
                </div>
                ...
                <div className='min-h-[100vh] px-[20%]'>
                    <div className='intro-graf'>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                                <p>I definitely could not read any Chinese characters at this point.</p>
                                <img className="h-[40vh]" src={image_folder + "me_bb.jpg"} alt="me, baby" title='me, baby, with larger baby' loading='lazy'></img>
                            </div>
                            <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                                <p>Maybe I could manage some Dr. Seuss. (This was also when my terrible posture began.)</p>
                                <img className="h-[40vh]" src={image_folder + "me_bb2.jpg"} alt="me, baby" title='me, baby, lounging' loading='lazy'></img>
                            </div>
                            <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                                <p>I have no idea what's going on here.</p>
                                <img className="h-[40vh]" src={image_folder + "me_bb3.jpg"} alt="me, baby" title='me, baby, party mode' loading='lazy'></img>
                            </div>
                            <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                ...
                <div className='min-h-[100vh] px-[20%]' style={{ paddingBottom: '40vh' }}>
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                            ...
                            <img className="h-[40vh]" src={portfolio_image_folder + "sketchbooks.png"} alt="my sketchbooks" title='(1/3 of ) my sketchbooks' loading='lazy'>
                            </img>
                        </div>
                        <div className='px-4 py-8 border-[1px] border-gray-600 border-solid rounded-[2px]'>
                            <p>I do it for 18 years, go to an arts high school, and deck out my grad cap:</p>
                            <img className="h-[40vh]" src={portfolio_image_folder + "grad_cap.jpg"} alt="my grad cap" title='my over-the-top grad cap' loading='lazy'>
                            </img>
                        </div>
                    </div>
                ...
                <div className='min-h-[100vh] px-[20%]'>
                    ...
                    <img className="width-[80%] max-w-[600px]" src={portfolio_image_folder + "icons/surface.png"} loading='lazy'></img>
                    <p>It's pretty cool; I learn stats ➗, I learn to code 🧑‍💻, and I learn more about our nervous system 🧠.</p>
                    <p>As I learn to code, I consider the possibility of making a website for selling art.</p>
                    <i className='text-sm text-gray-500'>"And I get to tend the rabbits." "An ... Look down there acrost the river, like you can almost see the place." - Of Mice and Men</i>
                    {/* <hr className='border-none outline-1 outline-black outline-dashed'></hr> */}
                    <p>I haven't figured out the selling the art part yet, but at least I learned how to make a website.</p>
                </div>
                ...
                <div className='min-h-[100vh] px-[20%]'>
                    ...
                    <ul>
                        ...
                        <li className='list-disc'>I try <a className='underline text-pink-400' href="https://thepigpencil.com/writing" target="_blank" title="writing section of pig pencil">writing</a>. Not writing well exactly, but writing nonetheless.</li>
                        <li className='list-disc'>I learn to make <a className='underline text-pink-400' href="https://tylerwu2222.wixsite.com/website/selected-work-3" target='_blank' title="pixel art by tyler wu">pixel art</a>. It's kind of fun.</li>
                        <li className='list-disc'>I make random websites for various purposes:</li>
                    </ul>
                    <PortfolioSection
                        title='Projects'
                        summary={<></>}
                        content={
                            <>
                                ...
                                <p>UCLA Library Business Services: <a className='underline text-pink-700' href="https://github.com/tylerwu2222/UCLA-Invoice-Helper" target='_blank'>Invoice Automation App</a></p>
                                <div className='grid items-end grid-cols-3 gap-[1vw]'>
                                    {portfolioData.projects.map((project, i) => {
                                ...
                                <p>
                                    <a className='underline text-pink-700' href="https://devpost.com/software/moodz-b6mn70" target="_blank">CalHacks - Most Fun Award: 2023</a>
                                </p>
                                <img
                                    className="h-[25vh]"
                                ...
                                <p>More projects on my <a className='underline text-pink-700 font-semibold' href='https://github.com/tylerwu2222?tab=repositories' target='_blank'>Github</a></p>
                            </>
                        }
                    />
                </div>
                ...
                <div className='min-h-[100vh] px-[20%]'>
                    <div className='floating-graf'>
                        ...
                        <p>I was able to build some freelance visualizations on this here blog,
                        ...
                        <div className='grid grid-cols-2'>
                            {
                                portfolioData.visualizations.map((v, i) => {
                                    ...
                                    if (v.gif == "none") {
                                        vizTN = <img
                                            className="w-[80vw] outline-[1px] outline-black outline transition transform hover:scale-105 duration-100 ease-in-out"
                                        ...
                                        if (v.gif.endsWith('.gif')) {
                                            ...
                                            vizTN = <video
                                                ...
                                                loop
                                                muted
                                                className="w-[80vw] outline-[1px] outline-black outline transition transform hover:scale-105 duration-100 ease-in-out" src={portfolio_image_folder + 'viz_gifs/' + v.gif}
                                            // loading="lazy"
                                            ></video>;
                                        }
                                    }
                                    ...
                                    return (
                                        <div
                                            key={i}
                                            className='flex flex-1 flex-col bg-teal-300 m-[1vw] pb-[2vh]'
                    ...
                    <div className='floating-graf'>
                        ...
                        <div className='grid grid-cols-4 gap-4'>
                            {portfolioData.inspo.map((inspo, i) => {
                                return <div key={i} className='px-4 py-8'>
                                    <a href={inspo.url} target='_blank'>
                                        <p className='text-sm text-pink-400 underline'>{inspo.site}</p>
                                        <img
                                            className="h-[6vh]"
                                            src={portfolio_image_folder + 'fave_sites/' + inspo.image}
                                            alt={inspo.site}
                                        ></img>
                                    </a>
                                </div>
                ...
                <div className='min-h-[100vh] px-[20%]'>
                    <PortfolioSection
                        ...
                        summary={<>
                            ...
                            <p className='text-sm'>(I forgot to do that with Tokyo, so you get a boring .png for now).</p>
                        </>}
                        content={
                                            ...
                                            <div key={i} className='flex flex-col items-center'>
                                                ...
                                                <ImageModal
                                                    imgTN={<img
                                                        ...
                                                        className="w-[30vw] ModalImageThumbnail"
                                                        alt={"mm-" + city.city}
                                                        title={city.city}
                                                        loading="lazy" />}
                                                    img={<img
