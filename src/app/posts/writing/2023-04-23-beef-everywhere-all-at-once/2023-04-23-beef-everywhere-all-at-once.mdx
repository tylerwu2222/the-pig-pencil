...
export const metadata = {
  ...
  title: "Beef Everywhere all at Once",
  authors: ["Tyler Wu"],
  tags: ["mental health", "film", "asian american"],
  readingTime: "5 min",
...
<Image src={eye} className='inline w-[60px]' alt='eye-icon'/>
...
It could be worth trying to just talk more honestly and brusquely in the day-to-day, but that often requires a lot of explaining after-the-fact.
...
<Image src={beef} className='inline w-[60px]' alt='beef-icon'/>
...
<Image src={leaf} className='inline w-[60px]' alt='leaf-icon'/>
