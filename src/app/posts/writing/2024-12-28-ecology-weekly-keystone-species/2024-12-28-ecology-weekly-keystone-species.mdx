...
<LightCallout>
**Note:** for this series. I've created a lil feature that lets you hover (or tap on mobile) <HoverDefinitionText hoverText={'the definition would appear here...'} link={'https://thepigpencil.com'} linkText={'sometimes with a link'}>green highlighted text</HoverDefinitionText> to show a definition and link to more information.
</LightCallout>
...
The key experiment that precipitated this term took place in 1963, when Paine was studying <HoverDefinitionText hoverText={'shallow pools in the rock face that appear when the tide recedes'} link={'https://en.wikipedia.org/wiki/Tide_pool'}>tide pool</HoverDefinitionText> communities. 
