...
The Mussel eats primarily plankton that it filters out of the water. The Star eats a little bit of everything, including, importantly, the Mussel.

Paine was curious what would happen if he *removed* the sea star entirely. 
To do this, he used a crowbar to pry up any he saw, and chucked them into the tide. 
(He had to do this repeatedly because sometimes the stars would come crawling back.)
...
One concept we can measure this with is "functional redundancy". The less redundant (more unique) the function/role a species plays, 
...
If one were to disappear, it would be unfortunate, but it's likely that the other two fish species could compensate.
...
Next time, we will be talking about these <a href="/posts/writing/2025-01-11-ecology-weekly-niche" target='_blank'>roles</a>, (in ecology called a "niche"), and how these roles arise through competition.
