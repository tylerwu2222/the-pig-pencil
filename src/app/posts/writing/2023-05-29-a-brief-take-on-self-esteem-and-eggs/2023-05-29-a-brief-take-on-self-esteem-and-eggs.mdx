import se1 from './self_esteem1.png'
import se2 from './self_esteem2.png'
...
export const metadata = {
  ...
  hasScrollspy: true,
  visibility: "visible",
  tags: ["mental health", "self-care", "motivation", "psychology"]
};

I was recently listening to this psychology podcast called [Hidden Brain](https://hiddenbrain.org/) discussing the concept of self-doubt.
...
<ScrollspyHeader header={'What is Self-esteem?'}/>
...
<ScrollspyHeader header={'High vs. Low Self-esteem'}/>
...
<Image src={se1}  alt={'self-esteem-1'}/>
{/* <img
  className='articleImg leftWrapImg'
  src='./self_esteem1.png'
  alt='self-esteem-1'
/> */}
...
<ScrollspyHeader header={'Self-esteem & Locus of Control'}/>
...
<Image src={se2} className={'float-right w-3/5'} alt={'self-esteem-2'}/>
{/* <img
