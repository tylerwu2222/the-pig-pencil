...
One of the biggest challenges we dealt with was defining the scope of our project. 
...
Thus, it was definitely a big time-crunch that left little time for me to style and make the app as accessible as I liked, 
(usually I love obsessing over styles), but it was still a good exercise of working within constraints.

<ScrollspyHeader header={'Reflection'}/>
Overall, it was still a great process to go through as I still learned quite a bit, 
not just about mobile dev, but communicating with a team, and working with deadlines.

In hindsight, I could've tried making more use of AI tools to generate a lot of the
But at the same time, I think doing a lot of the basic-component work "by hand" was also great for my learning, 
as I learned quite a bit from making lots of mistakes, reading docs, and planning things out on paper.