...
Other risks include:
  ...
  1. Getting stepped on. **solution:** pay attention with your ears, then perform an action roll evasive manuever  
  2. Falling asleep **solution:**: set an alarm or be naturally anxious such that you don't need an alarm OR just enjoy the extra sleep and deal with consequences later  
  3. Feeling kind of baked from all the heat **solution:** bring an umbrella, some ice water, or if you're near a major body of water, jump in said body of water  
  4. Feeling kind of baked from other factors **solution:** go home, or do whatever you enjoy doing when baked
